...
def train_STAGATE(adata, hidden_dims=[512, 30], n_epochs=500, lr=0.001, key_added='STAligner',
...
def train_STAligner(adata, hidden_dims=[512, 30], n_epochs=550, lr=0.001, key_added='STAligner',
